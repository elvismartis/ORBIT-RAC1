...
\begin{itemize}
    ...
    \item structural biology information about RAC1 and protein-protein interactions with partners 
...
\begin{table}
  ...
  \begin{tabular}{llccc}
   ...
   Initial PDB & Protein & Modulator/LIGAND & Size (nb atoms) \\
    ...
    4YON (docking)  & RAC1:PREX1  & NSC23766\textsuperscript{\emph{1}} &  \\
    4YON (docking)   & RAC1:PREX1    & IA-116\textsuperscript{\emph{1}} &  \\
    4YON (docking)   & RAC1:PREX1 & ZINC69391\textsuperscript{\emph{1}} &   \\
    4YON (docking)   & RAC1:PREX1   & EHT1864\textsuperscript{\emph{1}} &  \\
    \hline
  \end{tabular}
