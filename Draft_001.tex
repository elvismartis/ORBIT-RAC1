...
\begin{figure}[hbt!]
    ...
    \caption{Essential Dynamics of Rac1 protein to explain the opening and closing of the transient pockets induced by the cosolvent probes. \textbf{A}) \textit{apo}-Rac1 in  water. \textbf{B}) Identification of \textit{apo}-Rac1 conformationaal clusters in pure water based on essential dynamics using first two PCs. \textbf{C}) GTP-bound Rac1 in pure water. \textbf{D}) Identification of GTP-bound Rac1 conformational clusters in pure water based on essential dynamics using first two PCs. \textbf{E}) \textit{apo}-Rac1 in water+IPA. \textbf{F}) Identification of \textit{apo}-Rac1 conformational clusters in water+IPA based on essential dynamics using first two PCs. \textbf{G}) \textit{apo}-Rac1 in water+PHENOL. \textbf{H}) Identification of \textit{apo}-Rac1 conformational clusters in water+PHENOL based on essential dynamics using first two PCs.  \textbf{I}) \textit{apo}-Rac1 in water+TOLUENE. \textbf{J}) Identification of \textit{apo}-Rac1 conformational clusters in water+TOLUENE based on essential dynamics using first two PCs. Magenta colour indicates the P-loop region. Orange colour indicates switch I region. Green colour indicates switch II region. Yellow colour indicates helical insert.} 
    \label{fig:PCA}
\end{figure}
