...
We employed the POVME2 tool to identify and measure the pocket volume changes over the course of the MD trajectory. Rac1 was  simulated under different conditions (See \textbf{Table \ref{tbl: Detailed system studies}}). Prior to identifying the binding pockets, all binding partners including nucleotides were deleted from the trajectory. Pockets were identified using the starting conformation of Rac1 X-ray structure, and the pocket volume changes were monitored throughout the course of the simulation. In addition to the nucleotide binding site (\textbf{Figure \ref{fig:nucleotidepockets}A}), we identified four pockets on the Rac1 surface that we believe are potential new binding sites. Site P1  lies are the interjunction between switch I and II, while site P2 lies slightly downstream to Site P1. These sites form that interface region where GEFs and GAPs are known to dock and perform their functions (\textbf{Figure \ref{fig:otherpockets}A}).  Site P2 is the also in Rac1 is similar to the one in K-RAS and H-RAS \cite{sun2012discovery, maurer2012small} that is occupied by the covalent inhibitors in G12C RAS variants.  This site is present at a crucial location that can be used to modulate the dynamics of the switch regions, thereby modulating the binding of upstream of GEFs. We further hypothesise the possibility to occlude the nucleotide binding site by blocking the switch region conformation in a position such that it is unfavourable for GTP binding, thereby prolonging the nucleotide free state and prevent the downstream signalling. 
We measured pocket volume changes in the nucleotide binding site in response to various Rac1 binding partners. Nucleotide binding restricts the volume fluctuations under 3000\r{A}$^3$ (\textbf{Figure \ref{fig:nucleotidepockets}B}). Further, we tested the effect of removal of nucleotides (delGDP and delGTP in \textbf{Figure \ref{fig:nucleotidepockets}B}) and found that mean pocket volume and fluctuations in the volumes showed tendency to increase. It is now well established that GEF function by facilitating the dissociation of GDP, followed by GTP binding. The latter promotes the dissociation of GEFs from the Rac1 surface. The pocket volume fluctuations in the nucleotide binding site were significantly increased. However, the magnitude of increase was not the same for all GEFs used in this study. For example, PREX1 and DOCK2, showed volume changes with similar magnitude as seen in Rac1 devoid of nucleotides (delGDP and delGTP in \textbf{Figure \ref{fig:nucleotidepockets}B}). Interestingly, TIAM1 and VAV1 showed significantly enlarged nucleotide pocket. The volume fluctuations ranged from 2000\r{A}$^3$ to 4000\r{A}$^3$. We hypothesis that, such difference in pocket volume changes in presence of different GEF suggests that X-ray structure has perhaps captured the Rac1-GEF complexes either just after GDP dissociation (PREX1 and DOCK2) or in a state that was preorganised for GTP:$Mg^{2+}$ association.
