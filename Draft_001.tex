...
We employed the POVME2\cite{durrant2014povme} tool to identify and measure the pocket volume changes associated with each pocket. The pockets were identified using the starting conformation of Rac1 X-ray structure obtained under different conditions (See \textbf{Table \ref{tbl:pdbs}}). To measure the pocket volume changes in these new pockets, we simulated Rac1 under different conditions (\textbf{Table \ref{tbl:pdbs}}). Before measuring the pockets volumes, all binding partners, including nucleotides, were deleted from the trajectory.  To understand the volume changes of the nucleotide binding site in response to various Rac1 binding partners(\textbf{Table \ref{tbl:pdbs}}), we measured and compared the volume changes understand different binding conditions. 
