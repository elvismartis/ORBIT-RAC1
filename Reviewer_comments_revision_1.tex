...
\begin{enumerate}
    ...
    In order understand the proximity of the cosolvent molecular probes to the transient sites, we computed radial distribution function of the probes with the center of mass of the residues that form the transient site. The resulting figure is Supplementary Figure \textcolor{red}{S13}, and we updated the discussion in the main text to addresss this interesting comment. 
...
\textbf{Author Response}: we have updated Figure 2B to 2D to get RMSF values for all atoms, this does not change the overall results but also to get a finer-grained overview of the movements. Indeed, we observed that residue \textcolor{red}{F15} will fluctuate more in these new RMSF plot, but no correlation could be found with pockets volumes, and/or pocket evolution.
...
\textbf{Author Response}: We agree with the review, and have rephrases appropriately in the main text. Furthermore, we have included all-atom RMSF in Figure, which is more informative than the backbone RMSF. We believe that oftentimes, pocket opening can observed as a result side-chain rotations with minimal moment in the backbone. 
...
\textbf{Author Response}: We thank the reviewer for the pointing this out. We admit this confusion and have rectified it in the manuscript.
