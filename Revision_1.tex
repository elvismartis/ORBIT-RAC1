...
\begin{itemize}
    ...
    \item \textbf{Figure \ref{SI-fig:SI_P1_VOL}}: Time-evolution of pocket volume for Site P1.
    \item \textbf{Figure \ref{SI-fig:SI_P2_VOL}}: Time-evolution of pocket volume for Site P2.
    \item \textbf{Figure \ref{SI-fig:SI_P3_VOL}}: Time-evolution of pocket volume for Site P3.
    \item \textbf{Figure \ref{SI-fig:SI_P4_VOL}}: Time-evolution of pocket volume for Site P4.
    \item \textbf{Figure \ref{SI-fig:SI_RDF}}: Radial Distribution Function of the Molecular Probes computed for each of the new pockets identifoed in this work.
    \item \textbf{Figure \ref{SI-fig:SI_SASA_100ns}}: Analysis of the Solvent-Accessible Surface Area using a 1.4 \r{A} probe accross all the newly identified site to understand the effect of nucleotide and GEF binding.
    \item \textbf{Figure \ref{SI-fig:SI_SASA_cosolv}}: Analysis of the Solvent-Accessible Surface Area using a 1.4 \r{A} probe accross all the newly identified site to understand the effect of Molecular probes.
