...
\begin{figure}[ht!]
    ...
    \includegraphics[width=1\textwidth]{RMSD_of_Full_RAC1.jpg}
    \caption{XXX} 
...
\begin{figure}[ht!]
    ...
    \includegraphics[width=1\textwidth]{RMSD_of_P-loop.jpg}
    \caption{XXX} 
...
\begin{figure}[ht!]
    ...
    \includegraphics[width=1\textwidth]{RMSD_of_switch-I.jpg}
    \caption{XXX} 
...
\begin{figure}[ht!]
    ...
    \includegraphics[width=1\textwidth]{RMSD_of_switch-II.jpg}
    \caption{XXX} 
